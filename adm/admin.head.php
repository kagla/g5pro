...
<header id="hd">
    ...
    <div id="hd_top">
        ...
        <?php // 텍스트 로고 — 어떤 엔진인지 드러내지 않는 중립 이름을 쓴다 (그누보드5 표기 금지) ?>
        <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" title="<?php echo get_text($config['cf_title']); ?> 관리자">Admin<span class="logo_pro">PRO</span></a></div>
