...
<div class="ca-panel">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="ca_code" value="{{ $selected['ca_code'] }}" class="frm_input" size="24"
                       maxlength="{{ CART_CA_CODE_MAX }}" pattern="[A-Za-z0-9_-]{1,{{ CART_CA_CODE_MAX }}}">
                ...
                <span>영문·숫자·하이픈·언더라인 1~{{ CART_CA_CODE_MAX }}자 · 목록 주소와 CSV 에 쓰입니다</span>
            </td>
        </tr>
        <tr>
            <th scope="row">설명</th>
