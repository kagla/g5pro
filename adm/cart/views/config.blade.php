...
<table>
    ...
    <tr>
        ...
        <td><input type="text" name="cc_ship_jeju" value="{{ $cc['cc_ship_jeju'] }}" size="10" style="text-align:right" class="frm_input"> 원 <span class="txt_id">(배송지 우편번호가 63 으로 시작하면 자동 적용)</span></td>
    </tr>
    </tbody>
</table>
</div>
