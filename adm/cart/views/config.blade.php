...
{{-- 권역별 추가 배송비는 별도 화면(추가배송비)으로 뗐다 — 우편번호 구간이 수십 줄이 되면
     환경설정 한 장에 같이 두기에 너무 길고, 붙여넣기 같은 전용 도구가 붙는 자리다 --}}
<div class="local_desc02 local_desc">
    <p>제주·도서산간 <strong>추가 배송비</strong>는 왼쪽 메뉴의 <strong>추가배송비</strong>에서 정합니다.
       우편번호 구간으로 판정하고, 택배사가 주는 도서산간 목록을 붙여넣어 채울 수 있습니다.</p>
</div>
