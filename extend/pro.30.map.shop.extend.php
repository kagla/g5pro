<?php
/**
 * g5pro 화면 매핑 — 쇼핑몰(shop). 로드 순서 30번 (순서 설명은 pro.10.extend.php 머리말).
 * 서비스 단위로 매핑 파일을 나눈다: 기본(bbs·회원)은 pro.20.map.extend.php,
 * 쇼핑몰은 이 파일. 새 서비스가 생기면 pro.40.map.<서비스>.extend.php 로 추가한다.
