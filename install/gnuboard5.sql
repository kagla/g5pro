...
CREATE TABLE IF NOT EXISTS `g5_config` (
  ...
  `cf_ppurio_id` varchar(100) NOT NULL DEFAULT '',
  `cf_ppurio_pw` varchar(100) NOT NULL DEFAULT '',
  `cf_ppurio_from` varchar(20) NOT NULL DEFAULT '',
  `cf_ppurio_dev` tinyint(4) NOT NULL DEFAULT '0',
