...
$sql = " insert {$g5['g5_shop_order_table']}
            set od_id             = '$od_id',
                ...
                od_receipt_time   = ".pro_sql_date($od_receipt_time, $g5['g5_shop_order_table'], 'od_receipt_time').",
                od_misu           = '$od_misu',
                od_pg             = '$od_pg',
                od_tno            = '$od_tno',
                od_app_no         = '$od_app_no',
                ...
                od_status         = '$od_status',
                od_shop_memo      = '',
                od_hope_date      = ".pro_sql_date($od_hope_date, $g5['g5_shop_order_table'], 'od_hope_date').",
...
// g5pro: 주문서의 "회원정보에 저장" 체크 — 주문자 연락처·주소를 회원정보에 반영한다.
